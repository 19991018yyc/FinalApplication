...
public class LogonActivity extends AppCompatActivity implements View.OnClickListener,View.OnFocusChangeListener{
    ...
    private String[] typeArray = {"个人用户", "公司用户", "18990188"};
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(LogonActivity.this, mView);
            }
        }
    }
    ...
    private void loginSuccess() {
        ...
        builder.setPositiveButton("确定返回", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(LogonActivity.this, TabHostActivity.class);
                startActivity(intent);
            }
        });
